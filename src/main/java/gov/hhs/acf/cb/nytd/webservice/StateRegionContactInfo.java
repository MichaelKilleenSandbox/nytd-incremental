...
/**
 * StateRegionContactInfo bean class
 */
@SuppressWarnings( { "unchecked", "unused" })
public class StateRegionContactInfo implements org.apache.axis2.databinding.ADBBean
{
	/*
	 * This type was generated from the piece of schema that had name =
	 * stateRegionContactInfo Namespace URI =
	 * http://MLS.clearinghouse.caliber.com/ Namespace Prefix = ns1
	 */
	...
	protected String localRegionname;
	 ...
	 *           Regionname
	 */
	public void setRegionname(String param)
	{
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType)
		{
			...
			String namespacePrefix = registerPrefix(xmlWriter, "http://MLS.clearinghouse.caliber.com/");
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":stateRegionContactInfo", xmlWriter);
			}
			else
			{
	...
	{
		if (namespace.equals("http://MLS.clearinghouse.caliber.com/"))
		{
			return "ns1";
		}
	...
	private void writeStartElement(String prefix, String namespace,
                                   String localPart, javax.xml.stream.XMLStreamWriter xmlWriter)
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		if (localStatenameTracker)
		{
			elementList.add(new javax.xml.namespace.QName("", "statename"));
		...
		if (localRegionnameTracker)
		{
			elementList.add(new javax.xml.namespace.QName("", "regionname"));

			if (localRegionname != null)
			{
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRegionname));
			}
			else
			{
				throw new org.apache.axis2.databinding.ADBException("regionname cannot be null!!");
	...
	public static class Factory
	{
		 ...
		 */
		public static StateRegionContactInfo parse(javax.xml.stream.XMLStreamReader reader)
				throws Exception
		{
			StateRegionContactInfo object = new StateRegionContactInfo();
			...
			try
			{
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"stateRegionContactInfo".equals(type))
						{
							// find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (StateRegionContactInfo) ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "statename").equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue))
					{
						throw new org.apache.axis2.databinding.ADBException("The element: " + "statename"
								+ "  cannot be null");
					}

					String content = reader.getElementText();

					object.setStatename(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "regionname").equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue))
					{
						throw new org.apache.axis2.databinding.ADBException("The element: " + "regionname"
								+ "  cannot be null");
					}
					...
					object
							.setRegionname(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
